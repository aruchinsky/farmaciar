...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Actualizar Mis Datos</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                    <li class="breadcrumb-item active">Actualizar Mis Datos</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="container">
                            ...
                            <form action="<?php echo APP_URL; ?>app/ajax/userAjax.php" method="post" autocomplete="off" class="FormularioAjax">
                                ...
                                <input type="hidden" name="modulo_usuario" value="actualizar_pefil">
