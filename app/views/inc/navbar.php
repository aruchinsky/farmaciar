        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            ?>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="<?php echo APP_URL."productList/".$_SESSION['id']."/"; ?>" class="dropdown-item">
                            <i class="fa-solid fa-clock-rotate-left mr-2"></i> Administrar Productos
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="<?php echo APP_URL."userList/".$_SESSION['id']."/"; ?>" class="dropdown-item">
                            <i class="fa-solid fa-users mr-2"></i> Administrar Usuarios
                        </a>
                        <div class="dropdown-divider"></div>
            ...
            <div class="sidebar">
                            ...
                            <nav class="mt-2">
                                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                                        <!-- INFORME PRODUCTOS -->
                                        <li class="nav-item">
                                            <a href="<?php echo APP_URL; ?>productInform/" class="nav-link">
                                            <i class="fa-solid fa-clipboard-list"></i>
                                            <p>Informes de Productos</p>
                                            </a>
                                        </li>
